...
static const char *const autostart[] = {
  ...
  27   │     "tcsh","-c",", NULL,
  32   │     "bash","-c","$HOME/dwm/status.sh &", NULL,*/
        NULL /* terminate */
};
...
static const Rule rules[] = {
	...
	{ "Gimp",     NULL,       0,            1,           -1 },
	*/
     { "Thorium-browser",NULL,1<<2,0,0},
  { "firefox",    NULL,       1 << 3,       0,           0},
  { "obsidian",  NULL,            1 << 4,       0,        0 },
  { "Zotero",  NULL,           1 << 3,       0,   0 },
  { "de-dal33t-Start",        NULL,       1 << 7,      0,      0 },
  { "whatsapp-desktop-linux",    NULL,       1 << 8,    0,    0},
   /*#######################################################################*/
{ "Spyder", NULL,       1 << 1,       1,           0},
{ NULL,     "Figure" ,       1 << 1,       1,           0},
{ "Spyder", "Spyder",           1 << 0,       0, 1},
{ "TeXstudio",  NULL,            1 << 1,       0,      1 },
{ "zoom",  NULL,         1 << 2,       0,       1 },
{ "thunderbird",  NULL,         1 << 3,       0, 1 },
 { NULL,   "MATLAB",       1 << 5,       0,          1 },
};
...
static const Key keys[] = {
	...
	TAGKEYS(          XKB_KEY_7, XKB_KEY_KP_Divide,                  6),
